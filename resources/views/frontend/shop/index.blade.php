...
@section('styles')
<link rel="stylesheet" type="text/css" href="{{ asset('themes/styles/shop_styles.css') }}">
<link rel="stylesheet" type="text/css" href="{{ asset('themes/styles/shop_responsive.css') }}">
@endsection
@section('header')
    @include('frontend.layouts.header')
    <div class="home">
		<div class="home_background parallax-window" data-parallax="scroll" data-image-src="{{ asset('themes/images/shop_background.jpg') }}"></div>
...
<script src="{{ asset('themes/plugins/Isotope/isotope.pkgd.min.js') }}"></script>
<script src="{{ asset('themes/plugins/jquery-ui-1.12.1.custom/jquery-ui.js') }}"></script>
<script src="{{ asset('themes/plugins/parallax-js-master/parallax.min.js') }}"></script>
<script src="{{ asset('themes/js/shop_custom.js') }}"></script>
@endsection